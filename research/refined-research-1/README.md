...
- plan.md — current backlog and decision tracker scoped to Codex-focused work (use ?/??/?/?? to mirror ADR progress).
- nalysis/ — refined evaluations of persistence gaps and solution models referencing Codex internals (e.g., codex_gap_analysis.md, phase1_short_cache_research.md).
- 
otes/ — active scratchpad for Codex-specific observations (working_notes.md).
...
Use .codex/docs/project/research-implementation-plan.md to understand how this phase fits into the overall research roadmap and to update status icons as tasks complete.
